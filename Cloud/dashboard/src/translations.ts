...
export const translations: Record<"en" | "vi", SystemTranslation> = {
  en: {
    ...
    todaysPriorityActions: "Today task",
    noPendingActions: "No pending CEO action points today! All clean.",
    pendingCeoDecisions: "PENDING TASK",
  ...
  vi: {
    ...
    finance: "TÀI CHÍNH",
    documents: "GIẤY TỜ",
    aiAgentsTrace: "NHÂN SỰ AI",
    ceoCommandUnit: "Trung Tâm Điều Hành",
